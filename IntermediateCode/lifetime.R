...
## Function imported in from the KRSP Github:
# https://github.com/KluaneRedSquirrelProject/krsp-functions/blob/master/lifetime.R
...
write.csv(litter, "IntermediateData/litter.csv")
